...
class Ecoprogram(models.Model):
    ...
    host = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='ecoprogram_host')
    ...
    likes = models.ManyToManyField(Consumer, related_name='ecoprogram_likes', blank=True)
    views = models.BigIntegerField(default=0)
    organization = models.CharField(max_length=20)
    due_date = models.DateTimeField()
    cost = models.PositiveIntegerField()
    participant = models.ManyToManyField(Consumer, related_name='ecoprogram_participant', blank=True, through='EcoprogramApply', through_fields=('ecoprogram', 'guest'),)
...
class EcoprogramApply(models.Model):
    ...
    guest = models.ForeignKey(Consumer, on_delete=models.CASCADE, related_name='ecoprogram_apply_guest')
...
class Review(models.Model):
    ...
    profile_image = models.ForeignKey(Consumer, on_delete=models.CASCADE, related_name='review_profile_image')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
